...
> Be mindful of which reads you want to use. You may want to use reads that were filtered to remove sequences from host organism(s).
...
cd /working/dir/virus_read_mapping
mkdir -p WTS/
...
# Working directory
cd /working/dir/virus_read_mapping/WTS
